...
export interface NFTCrowdsaleInterface extends utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "getSalePhrase", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getUserMintedTokens",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "updateSalePhrase", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "userMintedTokens",
    data: BytesLike
  ): Result;
...
export interface NFTCrowdsale extends BaseContract {
  ...
  functions: {
    ...
    getMintPrice(
      _salePhrase: PromiseOrValue<BigNumberish>,
    ...
    updateSalePhrase(
      ...
      salePhrase: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
